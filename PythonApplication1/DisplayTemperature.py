#!/usr/bin/python
#source :https://bitbucket.org/MattHawkinsUK/rpispy-misc/raw/master/python/lcd_i2c.py
...
def main():
  ...
  while True:
    ...
    lcd_string("Environmental   ",LCD_LINE_1)
    ...
    # Send some more text
    lcd_string('Temp: {0:0.1f} C'.format(templature),LCD_LINE_1)
